...
this.spaceGroup.operations[i].setSigma (sigma);
return s;
}, "JU.Matrix,JU.Matrix,JU.Matrix");
...
Clazz_declarePackage ("J.symmetry");
Clazz_load (["JU.M4", "$.P3"], "J.symmetry.SymmetryOperation", ["java.lang.Float", "JU.List", "$.M3", "$.Matrix", "$.P4", "$.PT", "$.SB", "$.V3", "J.util.Escape", "$.Logger", "$.Measure", "$.Parser", "$.Quaternion"], function () {
c$ = Clazz_decorateAsClass (function () {
...
if (i < 3 && j >= 3 && a[i][j] != 0) this.isComplex = true;
}
...
this.mComplex =  new JU.M3 ();
var w = this.rsvs.getSubmatrix (0, 3, 3, this.modDim);
w = w.mul (this.sigma);
var a = w.getArray ();
for (var i = 0; i < 3; i++) for (var j = 0; j < 3; j++) this.mComplex.setElement (i, j, a[i][j]);


this.temp3b =  new JU.P3 ();
}this.temp3b.setT (atom1);
this.mComplex.transform2 (this.temp3b, this.temp3b);
this.transform2 (this.temp3, this.temp3);
this.temp3.x += this.temp3b.x;
this.temp3.y += this.temp3b.y;
this.temp3.z += this.temp3b.z;
System.out.println ("op=" + this.index + " " + this.xyz + " " + transX + " " + transY + " " + transZ);
} else {
this.transform2 (this.temp3, this.temp3);
