...
Clazz.load (["JU.M4", "$.P3"], "J.symmetry.SymmetryOperation", ["java.lang.Float", "JU.List", "$.M3", "$.Matrix", "$.P4", "$.PT", "$.SB", "$.V3", "J.util.Escape", "$.Logger", "$.Measure", "$.Parser", "$.Quaternion"], function () {
